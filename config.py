...
def set_cfg(cfg):
    ...
    cfg.model.n_atom_feats = 128
    cfg.model.n_atom_hid = 128
    cfg.model.kge_dim = 128
    cfg.model.rel_total = 128

    cfg.subgraph = CN()
    cfg.subgraph.hops = 3

    cfg.data = CN()
    cfg.data.train_ddi= "./data/drugbank/f0/train_data.csv"
    cfg.data.test_ddi= "./data/drugbank/f0/test_data.csv"
    cfg.data.valid_ddi= "./data/drugbank/f0/valid_data.csv"
    cfg.data.pt_path= "./data/drugbank/processed/t3/drug_graph_data.pt"
